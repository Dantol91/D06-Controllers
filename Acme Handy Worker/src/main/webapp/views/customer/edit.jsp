...
<form:form action="actor/customer/edit.do" id="formID"
...
<display:table pagesize="3" class="displaytag" keepStatus="true"
	name="socialProfiles" requestURI="actor/admin/customer/edit.do" id="row">
	...
	<spring:message code="customer.socialProfile.name"
		var="nameHeader" />
	...
	<security:authorize access="isAuthenticated()">
		<display:column>
			<a href="socialProfile/edit.do?socialProfileId=${row.id}"> <spring:message
					code="customer.socialProfile.edit" />
			</a>
		</display:column>
	</security:authorize>
...
<security:authorize access="isAuthenticated()">
	<div>
		<a href="socialProfile/create.do"> <spring:message
				code="customer.socialProfile.create" />
		</a>
	</div>
</security:authorize>
