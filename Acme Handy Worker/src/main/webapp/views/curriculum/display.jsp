...
<jstl:if test="${empty curriculum and (handyWorkerCurriculum.id eq curriculum.id)}">
...
<div id="curriculum" >
	...
	<jstl:if test="${handyWorkerCurriculum.id eq curriculum.id}">
	<input type="button" name="edit"
		value="<spring:message code="personalRecord.edit" />"
		onclick="javascript: relativeRedir('personalRecord/handyWorker/edit.do?personalRecordId=${curriculum.getPersonalRecord().getId()}')" />
	...
	<input type="button" name="edit"
		...
		onclick="javascript: relativeRedir('educationRecord/handyWorker/edit.do?educationRecordId=${educationRecord.getId()}')" />
	<br/>
	</jstl:if>
	</security:authorize>
	</jstl:forEach>
	...
	<input type="button" name="edit"
		...
		onclick="javascript: relativeRedir('professionalRecord/handyWorker/edit.do?professionalRecordId=${professionalRecord.getId()}')" />
	<br/>
	</jstl:if>
	</security:authorize>
	</jstl:forEach>
	...
	<input type="button" name="edit"
		...
		onclick="javascript: relativeRedir('endorserRecord/handyWorker/edit.do?endorserRecordId=${endorserRecord.getId()}')" />
	</jstl:if>
	</security:authorize>
	<br/>
	</jstl:forEach>
	...
	<input type="button" name="edit"
		...
		onclick="javascript: relativeRedir('miscellaneousRecord/handyWorker/edit.do?miscellaneousRecordId=${miscellaneousRecord.getId()}')" />
	</jstl:if>
	</security:authorize>
	<br/>
	</jstl:forEach>
	...
	<input type="button" name="edit"
		...
		onclick="javascript: relativeRedir('miscellaneousRecord/handyWorker/create.do')" />
	</jstl:if>
	</security:authorize>
	<br/>
	<br/>
...
<%-- BOTONES, SOLO LOS handyWorkerS PUEDEN EDITAR Y ELIMINAR SUS CURRICULUMS --%>

<security:authorize access="hasRole('HANDYWORKER')">
	<jstl:if test="${handyWorkerCurriculum.id eq curriculum.id}">
<form:form action="curriculum/handyWorker/edit.do" modelAttribute="curriculum">
	<form:hidden path="id"/>
